...
| -------------------------- | ------ | ---------- | ------------ | ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ffmpeg-9.0-ubuntu2404      | 24.04  | 9.x        | amd64, arm64 | [ubuntu](https://releases.ubuntu.com/)      | external libraries are installed from os packages, and ffmpeg is built from source. See [Ubuntu Compilation Guide](https://trac.ffmpeg.org/wiki/CompilationGuide/Ubuntu) for details on this. |
...
ffmpeg `<version>` can be one of the following: `8.0`, `8.1`, `9.0` with the above table.
